    ...
    <div class="row">
        ...
        <div class="col-md-2 col-lg-2">
            ...
            <ul class="list-group">
                ...
                <li class="menu list-group-item btn-link" onclick="setupReclamation()">Déposer Reclamation</li>
                <li class="menu list-group-item btn-link" onclick="fetchThemes()">Choisir Theme</li>
                <li class="menu list-group-item btn-link" onclick="fetchState()">Suivre Etat</li>
